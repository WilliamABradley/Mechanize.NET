...
namespace Mechanize.Forms.Controls.Options
{
    ...
    {
        internal ListOption(ListControl Parent, IHtmlNode Node)
        {
            this.Parent = Parent;
            this.Node = Node;
        }
        ...
        /// </summary>
        public virtual string Value => Node.GetAttribute("value", null);

        /// <summary>
        /// The Html "label" attribute for this option.
        /// </summary>
        public virtual string Label => Node.GetAttribute("label", null);
